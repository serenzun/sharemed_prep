...
Total_Cumulative_Intensity_relThresh_2015_2019 <-raster(file.path(dir_atlas,"marine heat waves/matjiaz analysis/ACCUMULATIONS-20220503T102923Z-001/ACCUMULATIONS/Total_Cumulative_Intensity_relThresh_2015_2019.nc"))

a <-nc_open(file.path(dir_atlas,"marine heat waves/Total_Cumulative_Intensity_relThresh_2015_2019.nc"))
plot(a) 
rasterVis::levelplot(Total_Cumulative_Intensity_relThresh_2015_2019)
...
rasterVis::levelplot(diff_yearsum)
